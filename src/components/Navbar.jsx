    ...
    <>
      <ul className={`${menuClicked ? 'hidden' : ''} absolute bg-white top-0 right-0 w-[256px] p-[24px] h-full text-[18px] sm:flex sm:items-center sm:w-[438px] sm:place-content-around sm:p-0 sm:h-auto sm:relative sm:text-[16px]`}>
        ...
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed sm:text-4 font-bold' href="#">Home</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed font-bold' href="#">New</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed font-bold' href="#">Popular</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed font-bold' href="#">Trending</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed font-bold' href="#">Categories</a>
        </li>
      </ul>
